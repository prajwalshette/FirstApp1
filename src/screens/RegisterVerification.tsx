...
type RegisterVerification = NativeStackScreenProps<RootStackParamList, 'RegisterVerification'>

const RegisterVerification = ({navigation, route}: RegisterVerification) => {
    ...
    const handleVerification = async () => {
      try {
        const response = await axios.post('http://localhost:5000/api/user/register/verify', {
          name: name,
          number: number,
